---
title: 营销域数据分析项目 知识快照
type: project_context_snapshot
project_id: data-project
project_name: 营销域数据分析项目
project_short_name: 营销域
project_code: data_project
source_repo_name: data_project
snapshot_prefix: 营销域数据分析项目
domain: 营销域
project_aliases:
  - 营销域
  - 营销域数据分析项目
...
snapshot_sequence: 4
exported_at: 2026-04-24T14:32:21
source_repo: D:/Dropbox/Project/data_project
source_branch: main
source_commit: bc37852
source_content_hash: 8db680bd642d5917
previous_snapshot: data_project-知识快照-2026-04-24-bc37852.md
supersedes: data-project:2026-04-24:bc37852
source_files:
  - context/tables.md
  - context/rules.md
...
- 项目中文名称：`营销域数据分析项目`。
- 稳定项目 ID：`data-project`；源仓库目录名：`data_project`。
- 业务域：`营销域`。
...
- 2026-04-24：输出文件为 `营销域数据分析项目-知识快照-2026-04-24-bc37852.md`。
- 2026-04-24：本次导出识别 `tables=36`、`rules=21`、`dictionary=17`。
- 2026-04-24：source_content_hash=`8db680bd642d5917`。
- 2026-04-24：比较基线为 `data_project-知识快照-2026-04-24-bc37852.md`。
